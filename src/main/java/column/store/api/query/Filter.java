...
public sealed interface Filter permits BaseFilter {
     ...
     */
    static BooleanFilter.Builder whereBoolean(BooleanColumn column) {
     ...
     */
    static DoubleFilter.Builder whereDouble(DoubleColumn column) {
     ...
     */
    static IdFilter.Builder whereId(IdColumn column) {
     ...
     */
    static LongFilter.Builder whereLong(LongColumn column) {
     ...
     */
    static StringFilter.Builder whereString(StringColumn column) {
        return new StringFilter.Builder(column);
    }

    abstract sealed class Builder permits BooleanFilter.Builder, DoubleFilter.Builder, IdFilter.Builder, LongFilter.Builder, StringFilter.Builder {
